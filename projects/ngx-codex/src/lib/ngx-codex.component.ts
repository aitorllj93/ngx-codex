...
import { NgxCodexTools } from './ngx-codex.tools';
...
@Component({
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => NgxCodexComponent),
    multi: true
  }]
})
export class NgxCodexComponent implements OnInit, ControlValueAccessor  {

  @Input() tools: NgxCodexTools;
